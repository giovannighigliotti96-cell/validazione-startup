...
OWNERS = dict(**COMMON, kicker="Per titolari di saloni · Milano", hero_card_title="In tre passi", quotes_title="Ti riconosci?", quotes_lead="Frasi vere di titolari di salone.",
    ...
    variants=[dict(key="A", target_language="it", headline="La poltrona vuota del tuo salone *rende 500 euro al mese*. Senza fare nulla.",
        ...
        objections=[{"objection": "Mi porta via le clienti?", "answer": "Le sue clienti sono sue, le tue sono tue: è scritto nel contratto. In pratica una postazione occupata porta più passaggio in salone, non meno."},
                    ...
                    {"objection": "Canone fisso o percentuale sugli incassi?", "answer": "Come preferisci. Il canone fisso (es. 500 €) è il più semplice e ti dà un'entrata certa; la percentuale sugli incassi della professionista (di solito 30-40%) rende di più se lei lavora tanto, ma va rendicontata. Il contratto standard prevede entrambe le formule; se vuoi, anche un fisso più una quota."},
